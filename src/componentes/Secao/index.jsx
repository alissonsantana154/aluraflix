...
function Secao({ categoria, cards, excluindo }) {
  ...
  const excluirCard = async () => {
    try {
      const resposta = await fetch(
        `https://668c6b2b0b61b8d23b0d4f6f.mockapi.io/cards/${idExcluir}`,
        {
          method: "DELETE",
        }
      )
  ...
  return (
    <ContainerSecao>
      <CategoriaTitulo categoria={categoria}>{categoria}</CategoriaTitulo>
      <CardContainer>
        <Notificacao
            ...
            <Card key={card.id}>
              ...
              <BoxBotoes categoria={categoria}>
                ...
                <Botoes>
                  ...
                  <BotaoEditar onClick={() => abrirModalParaEdicao(card.id)}>
                    EDITAR
                  </BotaoEditar>
                </Botoes>
              </BoxBotoes>
