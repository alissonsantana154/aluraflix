...
function VideoNovo() {
    ...
    if (Object.keys(novoErrors).length === 0) {
      try {
        const response = await fetch(
          "https://668c6b2b0b61b8d23b0d4f6f.mockapi.io/cards",
          {
            method: "POST",
            headers: {
        ...
        mostrarNotificacao(
          "Erro ao criar novo card. Por favor, tente novamente.",
          "error"
        )
      }
    } else {
  ...
  const combinarOnChanges =
    (limparErrosInputAoDigitar, aoMudar) => (evento) => {
            ...
            <BoxInputsPrimarios>
              <BoxInputs>
                ...
                <Input
                  ...
                  name="titulo"
                  value={titulo}
                  onChange={combinarOnChanges(
                    aoMudar,
                    limparErrosInputAoDigitar
                  )}
